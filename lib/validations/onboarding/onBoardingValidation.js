...
export const jobPreferencesSchema = z
  .object({
    ...
    minSalary: z
      .number()
      .int()
      .min(500, "Minimum salary must be at least 500")
    ...
    salaryCreditType: z.enum(SALARY_CREDIT_TYPES_VALUES).default("daily"),

    joiningPeriod: z.enum(JOINING_TYPE_VALUES).default("immediate"),

    shiftType: z.enum(SHIFT_TYPE_VALUES).default("full day"),
