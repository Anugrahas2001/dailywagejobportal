    ...
    try {
      ...
      if (!response.ok) {
        return rejectWithValue({
          message: message || "Failed to save profile details.",
        });
      }
...
export const step3Onboarding = createAsyncThunk(
  ...
  async ({ body }, { rejectWithValue }) => {
    try {
      ...
      if (!response.ok) {
        return rejectWithValue({
          message: message || "Failed to update bio and skills.",
        });
      }
      return { result, message };
    } catch (error) {
...
export const step4Onboarding = createAsyncThunk(
  ...
  async ({ profileImage }, { rejectWithValue }) => {
    try {
      ...
      if (!response.ok) {
        return rejectWithValue({
          message: message || "Failed to save profile image",
        });
      }
      return { result, message };
    } catch (error) {
...
export const verifyLogin = createAsyncThunk(
  ...
  async ({ token }, { rejectWithValue }) => {
    try {
      ...
      if (!response.ok) {
        return rejectWithValue({
          message: message || "Failed to verify logged in user.",
        });
      }
      return { data, message };
    } catch (error) {
...
export const login = createAsyncThunk(
  ...
  async ({ token, role }, { rejectWithValue }) => {
    ...
    try {
      ...
      if (!response.ok) {
        return rejectWithValue({
          message: message || "Failed to login with the user.",
        });
      }
      return { data, message };
    } catch (error) {
