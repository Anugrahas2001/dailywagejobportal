  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(step1Onboarding.fulfilled, (state, action) => {
        ...
        state.onboardPage = action.payload.onboardPage;
        state.isOnboardingCompleted = action.payload.isOnboardingComplete;

        localStorage.setItem("onboardPage", action.payload.onboardPage);
        localStorage.setItem(
          "isOnboardingCompleted",
          action.payload.isOnboardingComplete,
        );
